  ...
  <main class="w-screen h-screen flex flex-col items-center justify-center">
    <Card class="">
      <CardHeader class="space-y-1">
        <CardTitle class="text-2xl"> Join Whatever today </CardTitle>
        <CardDescription>
      ...
      <CardContent class="grid gap-4">
        ...
        <Button class="w-full" @click="signup"> Create account </Button>
        <div class="relative">
      ...
      <CardFooter>
        <CardDescription class="justify-center">
          ...
          <a href="/login" class="text-green-700">Sign in</a>
        </CardDescription>
      </CardFooter>
    </Card>
  </main>
